...
set_property PACKAGE_PIN V17 [get_ports {input_mode}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {input_mode}]
set_property PACKAGE_PIN V16 [get_ports {score_mode}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {score_mode}]
set_property PACKAGE_PIN W16 [get_ports {level_mode}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {level_mode}]
...
#set_property PACKAGE_PIN R2 [get_ports {btn_test}]					
...
#set_property PACKAGE_PIN L1 [get_ports {clk_test}]					
